...
# We use raw strings (r"...") to protect the code structure
content = r"""
'use client';
      ...
      <section className="bg-gray-900 text-white py-24 px-6">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
                {/* Airbnb - NEW IMAGE (Clean Bedroom) */}
                ...
                {/* Commercial - NEW IMAGE (Modern Office) */}
                ...
                {/* Construction - NEW IMAGE (Renovation Site) */}
...
def fix_service_images():
    print("🚑 Replacing Services Grid Images with Verified URLs...")
    ...
    print("👉 Refresh your browser. The 3 service cards should now have distinct, working images.")
