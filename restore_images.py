...
# We use a raw string (r"...") to prevent Python from messing with the React code
content = r"""
'use client';
        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
                ...
                <Link href="/construction-cleanup" className="group block relative h-80 rounded-2xl overflow-hidden hover:ring-4 ring-blue-600 transition">
                    <img src="https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&q=80" className="absolute inset-0 w-full h-full object-cover transition duration-500 group-hover:scale-110" />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/90 to-transparent"></div>
                    <div className="absolute bottom-0 p-8">
...
def restore_images():
    ...
    print("👉 Refresh your browser. All 3 images + Hero Background should be visible.")
