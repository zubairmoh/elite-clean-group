...
# We use raw strings to ensure the code is written exactly as is
content = r"""
'use client';
        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
                ...
                <Link href="/airbnb-turnover" className="group block relative h-80 rounded-2xl overflow-hidden hover:ring-4 ring-blue-600 transition">
                    <img 
                        src="https://images.unsplash.com/photo-1522771753033-6a58d87b3820?auto=format&fit=crop&q=80" 
...
def apply_final_fix():
    print("🚑 PATCHING IMAGES (FINAL ATTEMPT)...")
    path = "src/app/page.js"
    
    with open(path, "w", encoding="utf-8") as f:
        f.write(content.strip())
        
    print(f"✅ Updated {path} with high-stability URLs.")
    print("👉 IMPORTANT: Refresh your browser now.")
